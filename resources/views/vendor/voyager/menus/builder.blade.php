            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <label for="button">{{ __('Show as button') }}</label>
                        <select id="m_button" class="form-control" name="button">
                            <option value="false" selected="selected">{{ __('No') }}</option>
                            <option value="true">{{ __('Yes') }}</option>
                        </select><br>
                        <div id="m_class">
                            <label for="class">{{ __('Custom Class') }}</label>
                            <input type="text" class="form-control" id="m_class" name="class" placeholder="{{ __('Enter custom class here') }}"><br>
                        </div>
